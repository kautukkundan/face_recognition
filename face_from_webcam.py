...
for name in known_face_names:
    print(name)
    file_name="known/"+str(name)+".jpg"
    img_file=face_recognition.load_image_file(str(file_name))
    known_face_encoding=np.append(known_face_encoding,face_recognition.face_encodings(face_recognition.load_image_file(file_name))[0])
...
biden_image = face_recognition.load_image_file("known/Chetan Madan.jpg")
